...
const navigation = {
  links: [
    ...
    { name: 'Hire Developers', href: '#contactForm' },
    { name: 'Become a mentor', href: '/mentor' },
  ],
  informed: [
    { name: 'Discord server', href: 'https://bit.ly/team-tanay' },
    { name: 'Blog', href: 'https://www.roc8.careers/blog' },
    { name: 'Newsletter', href: 'https://airtable.com/shrtkCGZGfh0aSqBz' },
    { name: 'Job Board', href: '/Job' },
  ],
  contact: [
    { name: 'Email', href: 'mailto:team@roc8.careers' },
    { name: 'Telegram', href: 'https://t.me/swapagarwal' },
  ],
  social: [
    {
      name: 'Instagram',
